...
|--------------------|:------------------------------------:|:------------------------------------:|:------------------------------------:|:------------------------------------:|:------------------------------------:|
| **Ruby**           |                                      |                                      |                                      |                                      |                                      |
| 3.2.x              |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |   :icon{name="twemoji:cross-mark"}   |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |
...
| **Node.js**        |                                      |                                      |                                      |                                      |                                      |
| 20.x               |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |
| 18.x               |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |   :icon{name="twemoji:cross-mark"}   |   :icon{name="twemoji:cross-mark"}   |  :icon{name="openmoji:white-circle"}  |
...
| **Postgres**       |                                      |                                      |                                      |                                      |                                      |
| 16.x               |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |  :icon{name="openmoji:white-circle"}  |
| 15.x               |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="openmoji:white-circle"}  |
...
| **Redis**          |                                      |                                      |                                      |                                      |                                      |
| 7.x                |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="openmoji:white-circle"}  |
...
| **OpenSearch**     |                                      |                                      |                                      |                                      |                                      |
| 2.x                |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |  :icon{name="twemoji:check-mark-button"}  |   :icon{name="twemoji:cross-mark"}   |  :icon{name="openmoji:white-circle"}  |
...
| 4.0.x         | End of Life Now  | :icon{name="twemoji:cross-mark"}    |
| 3.5.x         | After 2023-12-31 | :icon{name="twemoji:warning"} |
| 3.4.x & prior | End of Life Now  | :icon{name="twemoji:cross-mark"}    |
