...
| 18.x |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
...
| 12.x         |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |
...
::alert{type="danger"}
**Always use caution when upgrading Postgres to a new major version, failure to plan this migration may result in data-loss!**
::
...
| 6.0           |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 5.0           |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| **Dragonfly** |                 **4.4**                 |                 **4.3**                 |                 **4.2**                 |              **4.1**               |
| 1.27          |   :icon{name="check-box-with-check"}    |    :icon{name="twemoji:cross-mark"}     |    :icon{name="twemoji:cross-mark"}     |  :icon{name="twemoji:cross-mark"}  |
| 1.26.3+       |   :icon{name="check-box-with-check"}    |    :icon{name="twemoji:cross-mark"}     |    :icon{name="twemoji:cross-mark"}     |  :icon{name="twemoji:cross-mark"}  |
| **Valkey**    |                 **4.4**                 |                 **4.3**                 |                 **4.2**                 |              **4.1**               |
| 8.1           |   :icon{name="check-box-with-check"}    |   :icon{name="twemoji:white-circle"}    |   :icon{name="twemoji:white-circle"}    | :icon{name="twemoji:white-circle"} |
| 8.0           |   :icon{name="check-box-with-check"}    |   :icon{name="twemoji:white-circle"}    |   :icon{name="twemoji:white-circle"}    | :icon{name="twemoji:white-circle"} |

::alert{type="warning"}
The use of Redis alternatives such as [Valkey](https://valkey.io) or [Dragonfly](https://www.dragonflydb.io) are recommended for use with the development branch of Mastodon only.
::
...
| 8.x                 |       :icon{name="twemoji:warning"}        |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |
...
::alert{type="success"}
Elasticsearch is officially the only supported full text search index, however OpenSearch (an Elasticsearch 7.x fork) is commonly used.
::
...
::alert{type="info"}
Mastodon is transitioning from ImageMagick to libvips starting with Mastodon 4.3.
...
| :icon{name="twemoji:warning"}              | Supported in this version, but deprecated or at end of life |
