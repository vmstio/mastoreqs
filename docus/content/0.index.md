...
You should always read the release notes for your version of Mastodon, and any product dependencies, before upgrading. For questions or comments please reach out to <a rel="me" href="https://vmst.io/@vmstan">@vmstan@vmst.io</a>.
::

|                                           |                                            |                                            |                                            |                                            |                                            |
| ----------------------------------------- | :----------------------------------------: | :----------------------------------------: | :----------------------------------------: | :----------------------------------------: | :----------------------------------------: |
| **[Ruby](/#ruby-versions)**               |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
...
| 3.1.x                                     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |     :icon{name="twemoji:white-circle"}     |
| 3.0.x                                     |      :icon{name="twemoji:cross-mark"}      |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
| **[Node.js](/#nodejs-versions)**          |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
...
| **[Redis](/#redis-forks)**                |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
...
| 6.0.x                                     |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |                                            |
| 5.0.x                                     |    :icon{name="twemoji:yellow-square"}     |    :icon{name="twemoji:yellow-square"}     |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |                                            |
| **[Elasticsearch](/#full-text-search)**   |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
| 8.x                                       | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} |     :icon{name="twemoji:white-circle"}     |
...
| **[OpenSearch](/#full-text-search)**      |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
| 2.x                                       | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} | :icon{name="twemoji:check-box-with-check"} |     :icon{name="twemoji:white-circle"}     |
...
| **[Libvips](/#libvips)**                  |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
| 8.13+                                     |  :icon{name="twemoji:check-mark-button"}   |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |
| **[ImageMagick](/#imagemagick-versions)** |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
| 7.x                                       |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
| 6.9.7-7+                                  |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
| **[FFmpeg](/#ffmpeg-versions)**           |                   **4.3**                  |                   **4.2**                  |                  **4.1**                   |                  **4.0**                   |                  **3.5**                   |
