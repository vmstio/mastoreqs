...
|                    | **v4.3.0 (Development)**                  | **v4.2.4 (Current)**                      | **v4.1.12 (Previous)**                    | **v4.0.12 (EOL)**                         | **v3.5.16 (EOL)**                         | **v3.4.10 (EOL)**                         |
|--------------------|:-----------------------------------------:|:-----------------------------------------:|:-----------------------------------------:|:-----------------------------------------:|:-----------------------------------------:|:-----------------------------------------:|
| **Ruby**           |                                           |                                           |                                           |                                           |                                           |                                           |
...
If you are having issues processing video or GIF files in your Mastodon instance, check for available updates to ffmpeg or make sure that your default path is using the correct version.
