...
| 3.1.x |    :icon{name="twemoji:cross-mark"}     |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 3.0.x |    :icon{name="twemoji:cross-mark"}     |    :icon{name="twemoji:cross-mark"}     |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 2.7.x |    :icon{name="twemoji:cross-mark"}     |    :icon{name="twemoji:cross-mark"}     |    :icon{name="twemoji:cross-mark"}     |   :icon{name="twemoji:warning"}    |
...
| 7.0.x |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 6.2.x |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 6.0.x |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |
| 5.0.x |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |      :icon{name="twemoji:warning"}      |   :icon{name="twemoji:warning"}    |

::alert{type="warning"}
There is limited support/testing of Redis alternatives such as [Valkey](https://valkey.io) or [Redict](https://redict.io).
...
| 8.x                 |       :icon{name="twemoji:warning"}        |       :icon{name="twemoji:warning"}        |       :icon{name="twemoji:warning"}        |       :icon{name="twemoji:warning"}        |
...
::alert{type="success"}
Administrators can choose either Elasticsearch or OpenSearch for full text search indexing.
Currently, only Elasticsearch 7.x is officially supported, however OpenSearch 2.x (an Elasticsearch 7.x fork) is compatible with Mastodon and commonly used.
::
