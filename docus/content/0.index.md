...
| 3.1.x                                     |      :icon{name="twemoji:cross-mark"}      |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |      :icon{name="twemoji:cross-mark"}      |
...
| 18.x                                      |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |      :icon{name="twemoji:cross-mark"}      |
...
| 6.2.x                                     | :icon{name="twemoji:check-box-with-check"} |  :icon{name="twemoji:check-mark-button"}   |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |
...
| 8.13+                                     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |
| **[ImageMagick](/#imagemagick-versions)** |                  **4.4**                   |                  **4.3**                   |                  **4.2**                   |                  **4.1**                   |
| 7.x                                       |    :icon{name="twemoji:yellow-square"}     |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
| 6.9.7-7+                                  |    :icon{name="twemoji:yellow-square"}     |    :icon{name="twemoji:yellow-square"}     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
| 6.x                                       |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |
| **[FFmpeg](/#ffmpeg-versions)**           |                  **4.4**                   |                  **4.3**                   |                  **4.2**                   |                  **4.1**                   |
| 7.1.x                                     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |
| 7.0.x                                     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |     :icon{name="twemoji:white-circle"}     |     :icon{name="twemoji:white-circle"}     |
| 6.1.x                                     |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |     :icon{name="twemoji:white-circle"}     |
...
| 3.4.x                                     |      :icon{name="twemoji:cross-mark"}      |      :icon{name="twemoji:cross-mark"}      |  :icon{name="twemoji:check-mark-button"}   |  :icon{name="twemoji:check-mark-button"}   |
