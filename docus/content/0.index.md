...
::alert{type="warning"}
The use of Redis alternatives such as [Valkey](https://valkey.io) or [Dragonfly](https://www.dragonflydb.io) are recommended for use by experienced administrators who are willing/able to provide feedback.
::
...
- [Mastodon](https://github.com/mastodon/mastodon/releases) (github.com/mastodon/mastodon)
